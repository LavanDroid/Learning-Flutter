...
class ReadMoreText extends StatefulWidget {
  const ReadMoreText(
    ...
    this.trimLength = 240,
    this.trimLines = 2,
    this.trimMode = TrimMode.mLength,
    this.style,
    this.textAlign,
    this.textDirection,
    this.locale,
  ...
  /// Used on TrimMode.mLength
  final int trimLength;

  /// Used on TrimMode.mLines
  final int trimLines;

  /// Determines the type of trim. TrimMode.mLength takes into account
  /// the number of letters, while TrimMode.mLines takes into account
  /// the number of lines
